...
def read_page(url):
    ...
    with sync_playwright() as p:
        ...
        # 🟢 CRITICAL FIX 1: Allow lazy-loaded dynamic diagrams, macro wrappers, 
        # and corporate iframes 3 seconds to fully render across the DOM tree
    ...
    for h in all_headings:
        ...
        # Clean clean visual layout tracking tags out of heading strings
    ...
    for i, heading in enumerate(heading_tags):
        ...
        # 🟢 CRITICAL FIX 2: AGGRESSIVE MULTI-VECTOR DIAGRAM DETECTION
        # Captures standard images, vector svgs, canvases, embedded objects, as well as 
        # any macro iframes used to paint rich architectural visio/gliffy charts.
        ...
        if has_direct_media or has_macro_wrapper:
            # Count the distinct media occurrences inside the section boundaries
