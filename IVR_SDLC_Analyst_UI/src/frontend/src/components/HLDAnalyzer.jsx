            ...
            <main style={{ minWidth: 0, minHeight: 0, height: "100%", overflow: "hidden", display: "flex", flexDirection: "column" }}>
                ...
                {analysisResult && !loading && (
                    ...
                    >
                        ...
                        >
                            <div>
                                <div style={{ fontSize: 20, fontWeight: 650, color: REPORT.ok }}>
                                    Architectural Findings
                                </div>
                                <div style={{ marginTop: 4, fontSize: 12, color: REPORT.inkSoft }}>
                                    Findings generated from the scoped Confluence HLD review.
                                </div>
                                {analysisResult.document_metadata && (
                                    <div style={{ marginTop: 5, fontSize: 11, color: REPORT.accent }}>
                        ...
                        <div style={{ display: "grid", gap: 16 }}>
                            <section>
                                <h4 style={{ color: REPORT.accent, margin: "0 0 10px" }}>
                                    Code Review Target Sections
                                </h4>
                                {analysisResult.review_required_sections?.length > 0 ? (
                                    analysisResult.review_required_sections.map((sec, idx) => (
                                        ...
                                        >
                                            <strong style={{ display: "block", color: REPORT.ink, fontSize: 13 }}>
                                                {sec.section_title}
                                            </strong>
                                            <p style={{ margin: "4px 0", color: REPORT.inkSoft, fontSize: 12.5 }}>
                                                {sec.context_summary}
                                            </p>
                                            <pre
                                                style={{
                                            ...
                                            >
                                                {sec.raw_text_content}
                                            </pre>
                                        </div>
                                    ))
                                ) : (
                                    <div style={{ color: REPORT.empty, fontSize: 12.5, fontStyle: "italic" }}>
                                        No critical text alignment violations flags raised.
                                    </div>
                                )}
                            </section>

                            <section>
                                <h4 style={{ color: REPORT.ok, margin: "4px 0 10px" }}>
                                    IVR Flow Requirements Profiles
                                </h4>
                                {analysisResult.ivr_flow_requirements?.length > 0 ? (
                                    analysisResult.ivr_flow_requirements.map((flow, idx) => (
                                        ...
                                        >
                                            ...
                                            <div style={{ margin: "4px 0", color: REPORT.inkSoft, fontSize: 12 }}>
                                                <strong>Trigger Parameter:</strong> {flow.trigger_condition}
                                            </div>
                                            {flow.intended_steps?.length > 0 ? (
                                                <ul style={{ margin: "6px 0 0", paddingLeft: 18, fontSize: 12.5, color: REPORT.ink }}>
                                                    {flow.intended_steps.map((step, sIdx) => (
                                                        <li key={sIdx} style={{ marginBottom: 2 }}>{step}</li>
                                                    ))}
                                                </ul>
                                            ) : (
                                                <div style={{ color: REPORT.empty, fontSize: 11.5, fontStyle: "italic" }}>
                                    ...
                                    <div style={{ color: REPORT.empty, fontSize: 12.5, fontStyle: "italic" }}>
                                        No functional routing branches documented here.
                                    </div>
                                )}
                            </section>
                        </div>
